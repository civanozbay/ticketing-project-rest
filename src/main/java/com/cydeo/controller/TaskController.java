...
public class TaskController {
    ...
    public ResponseEntity<ResponseWrapper> createTask(@RequestBody TaskDTO taskDTO){
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(new ResponseWrapper("tasks is created", HttpStatus.CREATED));
    }
    ...
    public ResponseEntity<ResponseWrapper> deleteTask(@PathVariable("taskId") Long taskId){
        ...
        return ResponseEntity.ok(new ResponseWrapper("tasks is deleted", HttpStatus.OK));
    }
    ...
    public ResponseEntity<ResponseWrapper> updateTask(@RequestBody TaskDTO taskDTO){
        ...
        return ResponseEntity.ok(new ResponseWrapper("tasks are listed", HttpStatus.OK));
    }
